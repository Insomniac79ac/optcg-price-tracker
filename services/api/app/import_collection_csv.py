...
from app.services.collection_csv import IMPORT_MODES, ImportResult, import_collection_csv
    ...
    if result.preview:
        ...
        for p in result.preview:
            print(
                ...
                f"(card_id={p.matched_card_id}, quantity={p.quantity}, status={p.status})"
            )
