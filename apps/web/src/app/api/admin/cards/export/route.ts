...
export async function GET(request: NextRequest) {
  ...
  const backendUrl = `${API_INTERNAL_URL}/admin/cards/export.csv`;
  ...
  try {
    ...
    console.error(
      `[admin-cards-export proxy] failed to reach backend at ${backendUrl}: ${
  ...
  // named cards_export_<date>.csv rather than rendering it inline.
