...
export async function GET(request: NextRequest) {
  ...
  const backendUrl = `${API_INTERNAL_URL}/collection/export.csv`;
  ...
  try {
    ...
    console.error(
      `[collection-export proxy] failed to reach backend at ${backendUrl}: ${
  ...
  // named collection_export_<date>.csv rather than rendering it inline.
