const COLLECTION_STATUS_STYLES: Record<string, string> = {
  hold: "bg-neutral-500/15 text-neutral-300 ring-neutral-500/30",
  watch: "bg-sky-500/15 text-sky-300 ring-sky-500/30",
...
export function CollectionStatusBadge({ status }: { status: string }) {
  const style = COLLECTION_STATUS_STYLES[status] ?? DEFAULT_STYLE;
  return (
    <span
